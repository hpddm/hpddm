...
int HpddmCustomOperatorSolve(const HpddmCustomOperator *const, int, int (*)(const HpddmCustomOperator *const, const K *, K *, int),
                             int (*)(const HpddmCustomOperator *const, const K *, K *, int), const K *const, K *const, int, const MPI_Comm *);
