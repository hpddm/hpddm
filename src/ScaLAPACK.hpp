...
class ScaLapack {
    public:
        ...
        static void workspace(const int* m, const int* n, const int* ia, const int* ja, const int* desca, int* lwork, int* lrwork, int* info) {
            *lwork = -1;
            ...
            if(!Wrapper<K>::is_complex) {
                ...
                *lrwork = -1;
                typename Wrapper<K>::ul_type rwkopt;
                if(pivoting)
        ...
        static void geqpf(const int*, const int*, K*, const int*, const int*, const int*, int*, K*, K*, const int*, typename Wrapper<K>::ul_type*, const int*, int*);
        static void geqrf(const int*, const int*, K*, const int*, const int*, const int*, K*, K*, const int*, typename Wrapper<K>::ul_type*, const int*, int*);
