                ...
                if(super::_co) {
                    ...
                    if(!super::_ev)
                        ...
                        if(super::_schur) {
                            ...
                            Wrapper<K>::template csrgemv<Wrapper<K>::I>(&transb, &(Subdomain<K>::_dof), &(super::_bi->_m), &(Wrapper<K>::d__2), false, super::_bi->_a, super::_bi->_ia, super::_bi->_ja, _primal, &(Wrapper<K>::d__0), super::_work);
