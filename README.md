...
&#185;The latest versions of icpc and pgc++ are not able to compile C++11 properly, if you want to use these compilers, please apply the following patch to the sources of HPDDM `sed -i '' 's/ nullptr>/ (void*)0>/g; s/static constexpr const char/const char/g' *.hpp`.  
