...
/*TEST
   ...
   testset:
      ...
      filter: egrep -v "[0-9]+ KSP " | grep -v "rows=" | grep -v "total: nonzeros=" | grep -v " I-node " | sed -E -e "s/CONVERGED_RTOL_NORMAL /CONVERGED_RTOL_NORMAL_EQUATIONS /g" -e "s/CONVERGED_RTOL iterations [68]$/CONVERGED_RTOL iterations 7/g" -e "s/CONVERGED_RTOL iterations (14|21)$/CONVERGED_RTOL iterations 13/g" -e "s/CONVERGED_RTOL_NORMAL_EQUATIONS iterations (8|1[245])$/CONVERGED_RTOL_NORMAL_EQUATIONS iterations 13/g" -e "s/CONVERGED_RTOL_NORMAL_EQUATIONS iterations (28|43)$/CONVERGED_RTOL_NORMAL_EQUATIONS iterations 32/g"
      test:
        suffix: 1
