...
\vspace*{-0.4cm}
\begin{center}
    \begin{longtable}{| >{\tt}p{.25\textwidth} | p{.49\textwidth}| p{.115\textwidth}| >{\tt}p{.05\textwidth} |} \hline
        ...
        variant & Left, right, or variable preconditioning & \texttt{left}, \texttt{right}, \texttt{flexible} & left \\ \hline
