...
test_bin/schwarz_cpp test_bin/schwarz_c test_examples/schwarz.py:
	...
	${MPIRUN} 4 $(subst test_,${SEP} ${TOP_DIR}/,$@) -hpddm_schwarz_coarse_correction additive -hpddm_geneo_nu=10 -hpddm_verbosity=2 -Nx 50 -Ny 50 -symmetric_csr -hpddm_master_p 2 -generate_random_rhs 8 -hpddm_krylov_method=bfbcg -hpddm_deflation_tol=1e-2 -hpddm_schwarz_method asm
